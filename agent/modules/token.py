...
# GetUserNameExA is in secur32.dll, not advapi32
secur32 = ctypes.WinDLL("secur32", use_last_error=True)
secur32.GetUserNameExA.restype = wintypes.BOOL
secur32.GetUserNameExA.argtypes = [
...
def _get_uid() -> dict:
    ...
    username = ""
    if secur32.GetUserNameExA(NameSamCompatible, buf, ctypes.byref(buf_size)):
